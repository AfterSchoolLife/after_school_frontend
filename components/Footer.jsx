...
const Footer = () => {
    return (
        <section className={lilita.variable}>
            <div className="w-full footer flex flex-col md:flex-row justify-between p-8 space-y-6 md:space-y-0">
                <div className="w-full md:w-1/3">
                    <h4 className="pb-6">ABOUT AFTERSCHOOLLIFE</h4>
                    <Link href="/"><h5 className="pb-2">About Us</h5></Link>
                    <Link href="/work"><h5>Careers</h5></Link>
                </div>
                <div className="w-full md:w-1/3">
                    <h4 className="pb-6">OUR PROGRAMS</h4>
                    <Link href="/school"><h5 className="pb-2">After School Programs</h5></Link>
