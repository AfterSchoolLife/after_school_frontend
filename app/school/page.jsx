...
const School = () => {
    return (
        <section className={`flex gap-8 flex-col ${lilita.variable}`}>
            <div className="flex flex-col md:flex-row">
                <img className="w-full md:w-1/2 school-img" alt='home page banner' src="/school/banner.jpg" />
                <div className="w-full md:w-1/2 p-8 pt-0 text-color-primary-1">
                    ...
                    <SchoolAutoComplete label="Find your School" />
                </div>
            </div>
        </section>
    );
